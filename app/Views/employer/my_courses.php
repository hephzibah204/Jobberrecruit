...
<div class="content">
    <div class="page-header">
        <div class="page-title">
            <h4 class="fw-bold"><i class="ti ti-book me-2"></i>My Enrolled Courses</h4>
            <h6>Track your enrolled courses and download your certificates</h6>
        </div>
        <div class="page-btn">
    ...
    <?php if (empty($enrollments)): ?>
        <div class="card">
            <div class="card-body text-center py-5">
                ...
                <p class="text-muted mb-4">Start your learning journey or upscale your team by enrolling in a course.</p>
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="mt-auto d-flex gap-2 flex-wrap">
                                <?php if ($isCompleted): ?>
                                    ...
                                    <?php if ($cert): ?>
                                        <a href="<?= base_url('training/certificate/download/' . $cert['id']) ?>" class="btn btn-success btn-sm flex-grow-1">
                                            <i class="ti ti-certificate me-1"></i>Certificate
                                        </a>
                                    <?php endif; ?>
                                    <a href="<?= base_url($rolePrefix . '/my-courses/' . $enrollment->course_id) ?>" class="btn btn-outline-primary btn-sm flex-grow-1">
                                        <i class="ti ti-player-play me-1"></i>Outline
                                    </a>
                                <?php else: ?>
                                    <a href="<?= base_url($rolePrefix . '/my-courses/' . $enrollment->course_id) ?>" class="btn btn-primary btn-sm flex-grow-1">
                                        <i class="ti ti-player-play me-1"></i>View Outline
                                    </a>
                                <?php endif; ?>
                            </div>
                        </div>
