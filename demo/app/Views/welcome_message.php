...
<head>
    ...
    <title>Jobber Recruit - Job Portal Platform </title>
  </head>
  <body>
      ...
      <div class="container">
        <div class="main-header">
          ...
          <div class="header-right">
            <div class="block-signin"><a class="text-link-bd-btom hover-up" href="page-register">Register</a><a class="btn btn-default btn-shadow ml-40 hover-up" href="page-signin">Sign in</a></div>
          </div>
        </div>
      </div>
    </header>
                  ...
                  <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                      <div class="card-grid-2 grid-bd-16 hover-up">
                        ...
                        <div class="card-block-info">
                          <h5><a href="job-details">React Native Web Developer</a></h5>
                          <div class="mt-5"><span class="card-location mr-15">New York, US</span><span class="card-time">3 mins ago</span></div>
                          <div class="card-2-bottom mt-20">
                            <div class="row">
                              <div class="col-xl-7 col-md-7 mb-2"><a class="btn btn-tags-sm mr-5" href="jobs-grid">Figma</a><a class="btn btn-tags-sm mr-5" href="jobs-grid">Adobe XD</a>
                              </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                      <div class="card-grid-2 grid-bd-16 hover-up">
                        ...
                        <div class="card-block-info">
                          <h5><a href="job-details">Digital Marketing Manager</a></h5>
                          <div class="mt-5"><span class="card-location mr-15">Chicago, US</span><span class="card-time">6 mins ago</span></div>
                          <div class="card-2-bottom mt-20">
                            <div class="row">
                              <div class="col-xl-7 col-md-7 mb-2"><a class="btn btn-tags-sm mr-5" href="jobs-grid">SEO</a><a class="btn btn-tags-sm mr-5" href="jobs-grid">Word</a>
                              </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                      <div class="card-grid-2 grid-bd-16 hover-up">
                        ...
                        <div class="card-block-info">
                          <h5><a href="job-details">Web Designer/Developer</a></h5>
                          <div class="mt-5"><span class="card-location mr-15">Chicago, US</span><span class="card-time">9 mins ago</span></div>
                          <div class="card-2-bottom mt-20">
                            <div class="row">
                              <div class="col-xl-7 col-md-7 mb-2"><a class="btn btn-tags-sm mr-5" href="jobs-grid">HTML</a><a class="btn btn-tags-sm mr-5" href="jobs-grid">CSS</a><a class="btn btn-tags-sm mr-5" href="jobs-grid">JS</a>
                              </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                      <div class="card-grid-2 grid-bd-16 hover-up">
                        ...
                        <div class="card-block-info">
                          <h5><a href="job-details">Full Stack Engineer</a></h5>
                          <div class="mt-5"><span class="card-location mr-15">Chicago, US</span><span class="card-time">13 mins ago</span></div>
                          <div class="card-2-bottom mt-20">
                            <div class="row">
                              <div class="col-xl-7 col-md-7 mb-2"><a class="btn btn-tags-sm mr-5" href="jobs-grid">NodeJS</a><a class="btn btn-tags-sm mr-5" href="jobs-grid">MongoDB</a>
                              </div>
                              <div class="col-xl-5 col-md-5 text-lg-end"><span class="card-text-price">$80 - $150</span><span class="text-muted">/Hour</span></div>
                            </div>
                          </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                      <div class="card-grid-2 grid-bd-16 hover-up">
                        ...
                        <div class="card-block-info">
                          <h5><a href="job-details">Frontend Developer Full time</a></h5>
                          <div class="mt-5"><span class="card-location mr-15">Chicago, US</span><span class="card-time">16 mins ago</span></div>
                          <div class="card-2-bottom mt-20">
                            <div class="row">
                              <div class="col-xl-7 col-md-7 mb-2"><a class="btn btn-tags-sm mr-5" href="jobs-grid">Bootstrap</a>
                              </div>
                              <div class="col-xl-5 col-md-5 text-lg-end"><span class="card-text-price">$80 - $150</span><span class="text-muted">/Hour</span></div>
                            </div>
                          </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                      <div class="card-grid-2 grid-bd-16 hover-up">
                        ...
                        <div class="card-block-info">
                          <h5><a href="job-details">React Native Mobile Developer</a></h5>
                          <div class="mt-5"><span class="card-location mr-15">Chicago, US</span><span class="card-time">30 mins ago</span></div>
                          <div class="card-2-bottom mt-20">
                            <div class="row">
                              <div class="col-xl-7 col-md-7 mb-2"><a class="btn btn-tags-sm mr-5" href="jobs-grid">React</a><a class="btn btn-tags-sm mr-5" href="jobs-grid">NextJS</a>
                              </div>
                              <div class="col-xl-5 col-md-5 text-lg-end"><span class="card-text-price">$80 - $150</span><span class="text-muted">/Hour</span></div>
                            </div>
                          </div>
