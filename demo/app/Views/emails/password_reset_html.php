...
<head>
    ...
    <title>Reset Your Password - JobberRecruit</title>
    <style>
        body {
    ...
    <table class="container" cellpadding="0" cellspacing="0" border="0" width="100%">
        ...
        <tr>
            <td class="content">
                ...
                <p>
                    You have requested to reset your password for your account with <strong>JobberRecruit</strong>.
                    To complete your request, please confirm your email address by clicking the button below:
                </p>

                <div style="text-align: center;">
                    <a href="<?= esc($resetLink) ?>" class="button" target="_blank" rel="noopener">
                        Reset Password
                    </a>
                </div>
                ...
                <p class="muted">
                    If you didn't make this request with JobberRecruit, you can safely ignore this email.
                </p>
            </td>
        </tr>
        <tr>
