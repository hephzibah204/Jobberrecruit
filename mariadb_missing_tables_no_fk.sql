...
-- VERSION: Without Foreign Keys (Safer for existing DBs)
...
-- -----------------------------------------------------
-- OPTIONAL: Add Foreign Keys Later (Run this separately after tables exist)
-- -----------------------------------------------------
/*
-- Foreign keys for conversations
ALTER TABLE `conversations` 
  ADD CONSTRAINT `fk_conversations_employer` FOREIGN KEY (`employer_id`) REFERENCES `employers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_conversations_job_seeker` FOREIGN KEY (`job_seeker_id`) REFERENCES `job_seekers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_conversations_job` FOREIGN KEY (`job_id`) REFERENCES `jobs` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;
...
-- Foreign keys for candidate_unlocks
ALTER TABLE `candidate_unlocks` 
  ADD CONSTRAINT `fk_candidate_unlocks_employer` FOREIGN KEY (`employer_id`) REFERENCES `employers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_candidate_unlocks_job_seeker` FOREIGN KEY (`job_seeker_id`) REFERENCES `job_seekers` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `payments` 
  ...
  ADD CONSTRAINT `fk_payments_employer` FOREIGN KEY (`employer_id`) REFERENCES `employers` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;
...
-- Foreign keys for job_credit_wallets
ALTER TABLE `job_credit_wallets` 
  ADD CONSTRAINT `fk_job_credit_wallets_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- Foreign keys for job_credit_transactions
ALTER TABLE `job_credit_transactions` 
  ADD CONSTRAINT `fk_job_credit_transactions_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
*/
