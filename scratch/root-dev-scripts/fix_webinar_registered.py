...
file_path = r"C:\Users\hephz\Documents\CODEBASE\Jobberrecruit\app\Views\webinar_registered.php"

with open(file_path, 'r', encoding='utf-8') as f:
    content = f.read()

# Replace the wrong brand color just in case (though bulk replace should have done it)
...
print("Fixed webinar_registered.php CSS")
