...
file_path = r"C:\Users\hephz\Documents\CODEBASE\Jobberrecruit\app\Views\certificates\verify.php"
...
content = re.sub(r'\.skip-link\s*\{[^}]+\}', '', content)

with open(file_path, 'w', encoding='utf-8') as f:
    f.write(content)

print("Fixed verify.php CSS")
